...
class Agent():
  ...
  def train(self, file_target_actions,file_target_next_state_values,file_target_next_state_values2,
      ...
      # Add  hack values and  set rewards and done value to 0 for that
      embeddings_df.loc[6] = [-3.396226415,-5.408805031]
      embeddings_df.loc[12] = [-3.396226415,-5.408805031]
      embeddings_df.loc[18] = [-3.396226415,-5.408805031]
      embeddings_df.loc[24] = [-3.396226415,-5.408805031]
      embeddings_df.loc[30] = [-3.396226415,-5.408805031]
      embeddings_df.loc[36] = [-3.396226415,-5.408805031]
      embeddings_df.loc[42] = [-3.396226415,-5.408805031]
      embeddings_df.loc[48] = [-3.396226415,-5.408805031]
      embeddings_df.loc[54] = [-3.396226415,-5.408805031]
      embeddings_df.loc[60] = [-3.396226415,-5.408805031]
      embeddings_df.loc[63] = [-3.396226415,-5.408805031]
      ...
      for index, row in embeddings_df.iterrows():
        ...
        critic_early = agent.critic_main.early_call(states, actions)
        ...
        critic_mid = agent.critic_main.mid_call(states, actions)
