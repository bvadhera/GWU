...
# Helper Files
import actorCriticAgent_VA
import helperFunctions
import randomNetworkGeneration
import reinforcementTraining_VA
...
agent = actorCriticAgent_VA.Agent()

### Read the Critic Weights 
...
agent = reinforcementTraining_VA.rlTraining(test_nn_rl, model, agent, divideBy, maxNumOfLayers, minNumOfLayers,current_dir)
