...
# Helper Files
import actorCriticAgent_UpdatedAccuracyModelLamdaForwardLookupTree
import helperFunctions_JustAccuracyLamdaForwardLookupTree
import randomNetworkGeneration_UpdatedAccuracyModelLamdaForwardLookupTree
import reinforcementTraining_AccuracyTrainedCriticTrainedWithInputDataForwardTree 
...
randomNetworkGeneration_UpdatedAccuracyModelLamdaForwardLookupTree.removeOneHotColumns(trainProperties)
print("normalizeProp")
print(normalizeProp)
...
num_layers,num_node1,num_node2 = randomNetworkGeneration_UpdatedAccuracyModelLamdaForwardLookupTree.getRandomLegalNetwork(divideBy,maxNumOfLayers, minNumOfLayers ) # generate valid normalize network
...
agent = actorCriticAgent_UpdatedAccuracyModelLamdaForwardLookupTree.Agent()
        
# load weights in a file
agent.actor_main.load_weights(filepath + "/random_hack0915/" + "actor_main_weights")
agent.actor_target.load_weights(filepath + "/random_hack0915/" + "actor_target_weights")
agent.critic_main.load_weights(filepath + "/random_hack0915/" + "critic_main_weights")
agent.critic_main2.load_weights(filepath + "/random_hack0915/" + "critic_main2_weights")
agent.critic_target.load_weights(filepath + "/random_hack0915/" + "critic_target_weights")
agent.critic_target2.load_weights(filepath + "/random_hack0915/" + "critic_target2_weights")


agent = reinforcementTraining_AccuracyTrainedCriticTrainedWithInputDataForwardTree.rlTraining(test_nn_rl, model, agent, divideBy, maxNumOfLayers, minNumOfLayers,current_dir)
...
agent.actor_main.load_weights(filepath + "/random_hackGamma01/" + "actor_main_weights")
agent.actor_target.load_weights(filepath + "/random_hackGamma01/" + "actor_target_weights")
agent.critic_main.load_weights(filepath + "/random_hackGamma01/" + "critic_main_weights")
agent.critic_main2.load_weights(filepath + "/random_hackGamma01/" + "critic_main2_weights")
agent.critic_target.load_weights(filepath + "/random_hackGamma01/" + "critic_target_weights")
agent.critic_target2.load_weights(filepath + "/random_hackGamma01/" + "critic_target2_weights")
