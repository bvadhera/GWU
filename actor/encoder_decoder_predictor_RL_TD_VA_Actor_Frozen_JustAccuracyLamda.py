...
# Helper Files
import actorCriticAgent_UpdatedAccuracyModelLamda
import helperFunctions_JustAccuracyLamda
import randomNetworkGeneration_UpdatedAccuracyModelLamda
import reinforcementTraining_JustAccuracyTrainedLamdaLast50 
...
randomNetworkGeneration_UpdatedAccuracyModelLamda.removeOneHotColumns(trainProperties)
print("normalizeProp")
print(normalizeProp)
...
num_layers,num_node1,num_node2 = randomNetworkGeneration_UpdatedAccuracyModelLamda.getRandomLegalNetwork(divideBy,maxNumOfLayers, minNumOfLayers ) # generate valid normalize network
...
print('####################################################################################')
agent = actorCriticAgent_UpdatedAccuracyModelLamda.Agent()
agent = reinforcementTraining_JustAccuracyTrainedLamdaLast50.rlTraining(test_nn_rl, model, agent, divideBy, maxNumOfLayers, minNumOfLayers,current_dir)
...
randomNetworkGeneration_UpdatedAccuracyModelLamda.generateEmbeddingsCritic(grid_DataSet, agent,current_dir)
randomNetworkGeneration_UpdatedAccuracyModelLamda.generateEmbeddingsActor(grid_DataSet, agent,current_dir)
...
if random100:
    ...
    for index1 in range(100):
        sameStartNode = False
        encoded_x, encoded_y,n_layers,num_node1,num_node2, prev_accuracy,reward,total_reward,qValue1, qValue2, qActions_1, qActions_2, qActions_3= helperFunctions_JustAccuracyLamda.getPolicyoutput(index1,model,agent,divideBy,maxNumOfLayers, minNumOfLayers, decoder_model,current_dir)
        ...
        state, num_layers,num_node1,num_node2, accuracy_state = randomNetworkGeneration_UpdatedAccuracyModelLamda.getStateAndAccuracy(model,divideBy,maxNumOfLayers, minNumOfLayers)
else:
    #  same as testNN
    sameStartNode = True                     
    encoded_x, encoded_y,n_layers,num_node1,num_node2, prev_accuracy,reward,total_reward,qValue1,qValue2,qActions_1, qActions_2,qActions_3 = helperFunctions_JustAccuracyLamda.getPolicyoutput(0,model,agent,divideBy,maxNumOfLayers, minNumOfLayers, decoder_model,current_dir )
    # save into a csv file
    writerPolicyOutPut.writerow({ 'encoded_x' : encoded_x, 
            'encoded_y' : encoded_y, 
            'layers' : n_layers,
