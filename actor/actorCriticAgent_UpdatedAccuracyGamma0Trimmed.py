...
class Agent():
  ...
  def train(self, file_target_actions,file_target_next_state_values,file_target_next_state_values2,
      ...
      with tf.GradientTape() as tape1, tf.GradientTape() as tape2:
          ...
          target_values1  = rewards + gammaU * ((next_state_target_value)) - ((current_state_target_value)[0])  # Q-V (Target for Advantage Value)
          target_values2  =  rewards + gammaU * ((next_state_target_value)) #Target Value  for V
