...
import reinforcementTraining_act_true
...
agent = reinforcementTraining_act_true.rlTraining(test_nn_rl, model, agent, divideBy, maxNumOfLayers, minNumOfLayers,current_dir)
