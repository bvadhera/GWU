...
agent.actor_main.load_weights(filepath + "random_hack_test/" + "actor_main_weights")
agent.actor_target.load_weights(filepath + "random_hack_test/" + "actor_target_weights")
agent.critic_main.load_weights(filepath + "random_hack_test/" + "critic_main_weights")
agent.critic_main2.load_weights(filepath + "random_hack_test/" + "critic_main2_weights")
agent.critic_target.load_weights(filepath + "random_hack_test/" + "critic_target_weights")
agent.critic_target2.load_weights(filepath + "random_hack_test/" + "critic_target2_weights")
