...
# Helper Files
import actorCriticAgent_VA_Clean
import helperFunctions
import randomNetworkGeneration
import reinforcementTraining_VA_Clean
...
filepath_acc=current_dir +"acc_acc/"
...
agent = actorCriticAgent_VA_Clean.Agent()


agent = reinforcementTraining_VA_Clean.rlTraining(test_nn_rl, model, agent, divideBy, maxNumOfLayers, minNumOfLayers,current_dir)
...
if random100:
    ...
    for index1 in range(100):
        sameStartNode = False
        encoded_x, encoded_y,n_layers,num_node1,num_node2, prev_accuracy,reward,total_reward,qValue1, qValue2, qActions_1, qActions_2 = helperFunctions.getPolicyoutput(index1,model,agent,divideBy,maxNumOfLayers, minNumOfLayers, decoder_model,current_dir)
        # save into a csv file
    ...
    #  same as testNN
    sameStartNode = True                     
    encoded_x, encoded_y,n_layers,num_node1,num_node2, prev_accuracy,reward,total_reward,qValue1,qValue2,qActions_1, qActions_2 = helperFunctions.getPolicyoutput(0,model,agent,divideBy,maxNumOfLayers, minNumOfLayers, decoder_model,current_dir )
    # save into a csv file
    writerPolicyOutPut.writerow({ 'encoded_x' : encoded_x, 
            'encoded_y' : encoded_y, 
            'layers' : n_layers,
