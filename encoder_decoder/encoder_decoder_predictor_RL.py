...
def getAction_probs(concat_output, model):
    ...
    action_func = K.function([model.get_layer('dense_9').input],
                                    [model.get_layer('actor_0utput').output])
...
def getCritic_probs(concat_output, model):
    print ('model.get_layer(dense_11).input.type:', type(model.get_layer('dense_11').inputput) )
    critic_func = K.function([model.get_layer('dense_11').input],
